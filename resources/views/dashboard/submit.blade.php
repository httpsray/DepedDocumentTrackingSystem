...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .fixed-office {
            width:100%; padding:10px 13px; border:1.5px solid #bfdbfe; border-radius:10px;
            background:#eff6ff; color:#1e3a8a; font-size:13px; font-weight:600;
        }
    ...
    <div id="formState">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn-submit" id="submitBtn" onclick="submitDocument()" data-no-auto-loading>
...
(function () {
    ...
    function fieldErr(inputId, errId) {
        ...
        var er = document.getElementById(errId); if (er) er.classList.add('show');
    }
