        ...
        <div class="nav-actions">
            ...
            <div class="nav-user">
                ...
                <div class="nav-user-info">
                    <span class="nav-user-name" title="{{ $isRep ? $user->name : '' }}">{{ $navDisplayName }}</span>
    ...
    <div class="dash-wrapper">
        ...
        <div class="top-bar anim">
            <div class="greeting-section">
                <h1>{{ $navDisplayName }}'s Dashboard</h1>
        ...
        <div class="stats">
            ...
            <div class="stat-card orange anim">
                ...
                <div class="s-data">
                    <div class="s-num">{{ $stats['pending'] }}</div>
            ...
            <div class="stat-card green anim">
                ...
                <div class="s-data">
                    <div class="s-num">{{ $stats['completed'] }}</div>
