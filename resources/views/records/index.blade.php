...
<div class="main">
    <div class="page-header">
        <div class="page-header-top">
            <div>
                ...
                <p>View and monitor every document that enters DOCTRAX &mdash; {{ $roleName }} Access</p>
            </div>
    ...
    <div class="archive-warning">
        ...
        <div><strong>{{ $stats['archived'] }}</strong> document(s) have been auto-archived after 7 days without being received. Use status filter "Archived" to review them.</div>
    </div>
    @endif
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card c-amber">
            ...
            <div class="stat-num" id="stat-submitted">{{ $stats['submitted'] }}</div>
            <div class="stat-sub">Submitted</div>
        </div>
        <div class="stat-card c-green">
            <div class="stat-label">Processing</div>
            <div class="stat-num" id="stat-received">{{ $stats['received'] }}</div>
        ...
        <div class="stat-card c-slate">
            ...
            <div class="stat-num" id="stat-archived">{{ $stats['archived'] }}</div>
        ...
        <div class="table-head">
            ...
            <form method="GET" action="/records/documents" class="filters" id="filterForm">
                <div class="search-wrap">
                    ...
                    <input type="text" name="search" value="{{ $search }}" placeholder="Search reference, subject, sender...">
                </div>
            ...
            <table id="docsTable">
                ...
                @foreach($documents as $doc)
                    <tr class="doc-row" onclick='openDocDetail(@json($doc->tracking_number))'>
                        ...
                        <td class="td-action">
                            <button class="btn-view" onclick="event.stopPropagation(); openDocDetail('{{ $doc->tracking_number }}')">
