    ...
    <div class="profile-card anim">
        ...
        <div class="profile-info-grid">
            ...
            <div class="info-item">
                ...
                <div class="info-value">{{ $isRep ? 'Representative Account' : 'Individual' }}</div>
            </div>
            <div class="info-item">
            ...
            <form id="profileForm" novalidate>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="firstName" value="{{ $repFirst }}" maxlength="100" autocomplete="off" oninput="this.value=this.value.replace(/[^a-zA-Z\u00C0-\u024F\s\-\.\x27]/g,'')">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="lastName" value="{{ $repLast }}" maxlength="100" autocomplete="off" oninput="this.value=this.value.replace(/[^a-zA-Z\u00C0-\u024F\s\-\.\x27]/g,'')">
                        <div class="field-err" id="err-lastName"><i class="fas fa-exclamation-circle"></i><span></span></div>
                    </div>
                </div>
                <div class="form-row full">
                    <div class="form-group">
                        <label for="middleName">Middle Name <span style="color:#dc2626" id="midRequired">{{ empty($repMiddle) ? '' : '*' }}</span></label>
                        <input type="text" id="middleName" value="{{ $repMiddle }}" maxlength="100" autocomplete="off" oninput="this.value=this.value.replace(/[^a-zA-Z\u00C0-\u024F\s\-\.\x27]/g,'')" {{ empty($repMiddle) ? 'disabled style="opacity:.5"' : '' }}>
                        ...
                        <label style="display:flex;align-items:center;gap:6px;margin-top:6px;cursor:pointer;font-size:12px;color:#64748b;font-weight:400;user-select:none;">
                            <input type="checkbox" id="noMiddleName" onchange="toggleProfileMiddle()" style="width:14px;height:14px;accent-color:#0056b3;cursor:pointer;" {{ empty($repMiddle) ? 'checked' : '' }}>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="mobile" value="{{ $user->mobile ?? '' }}" placeholder="e.g. 09171234567" maxlength="11" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,11)" autocomplete="off">
