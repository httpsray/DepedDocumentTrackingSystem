...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .contact-hero h2 { font-size:clamp(20px,4vw,28px); font-weight:700; color:var(--primary); margin-bottom:6px; }
        .contact-hero p { font-size:clamp(13px,2.5vw,15px); color:#355075; max-width:480px; margin:0 auto; line-height:1.7; }
        .contact-card { background:#fff; border-radius:18px; box-shadow:0 14px 34px rgba(0,86,179,.10); padding:32px; border:1px solid rgba(0,86,179,.14); margin-bottom:24px; text-align:left; }
        ...
        .contact-detail h4 { font-size:14px; font-weight:700; color:var(--primary); margin-bottom:6px; }
        .contact-detail { width:auto; padding-top:2px; }
        .contact-detail p { font-size:13px; color:#355075; line-height:1.7; margin:0; }
...
<div class="main">
    <div class="contact-wrapper">
        ...
        <div class="contact-card">
            ...
            <div class="contact-item">
                <div class="contact-icon" style="background:rgba(0,86,179,.16);color:var(--primary)">
