            ...
            <div class="card" style="margin-bottom:18px">
                <div class="card-head">
                    <div>
                        ...
                        <?php if($document->reference_number): ?><p style="font-family:monospace;letter-spacing:.5px"><?php echo e($document->reference_number); ?></p><?php endif; ?>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(in_array($document->status, ['in_review'])): ?>
                            <div class="action-section">
                        ...
                        <?php if(in_array($document->status, ['in_review','on_hold','for_pickup'])): ?>
                            <div class="action-section">
                        ...
                        <?php if(!$canAccept && !in_array($document->status, ['in_review','on_hold','for_pickup'])): ?>
            ...
            <div class="modal-body">
                ...
                <select class="modal-field" id="forwardOffice">
                    ...
                    <?php $__currentLoopData = $offices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($office->id !== $user->office_id): ?>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\representative\document.blade.php ENDPATH**/ ?>