    ...
    <div class="main-wrapper">
        <div class="auth-container">
            ...
            <div class="auth-header">
                ...
                <p>Create a strong password for <strong><!--email_off--><?php echo e($email); ?><!--/email_off--></strong>. You'll be signed in automatically after.</p>
            </div>
            ...
            <form id="reset-form" autocomplete="off" novalidate>
                <input type="hidden" id="token" value="<?php echo e($token); ?>">
                <input type="hidden" id="email" value="<?php echo e($email); ?>">
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>