...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .contact-detail .label { font-size:11px; font-weight:700; color:var(--primary); text-transform:uppercase; letter-spacing:.6px; margin-bottom:4px; }
        .contact-detail .value { font-size:14px; font-weight:600; color:var(--text-dark); }
        .contact-detail .value a { color:var(--primary); text-decoration:none; }
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views/dashboard/contact.blade.php ENDPATH**/ ?>