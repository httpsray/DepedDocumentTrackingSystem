...
<div class="main">
    <?php if(request()->query('from') === 'reports'): ?>
    <a href="/office/search" class="back-link"><i class="fas fa-arrow-left"></i> Back to Reports</a>
    <?php else: ?>
                ...
                <div class="card-body">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="value"><?php echo e($document->sender_email ?: 'No email provided'); ?></div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="value"><?php echo e($document->created_at->format('F d, Y h:i A')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php else: ?>
                        ...
                        <?php $__currentLoopData = $tlGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tlGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = array_reverse($tlGroup['logs']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tlLog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <div class="tl-item<?php echo e($isVoided ? ' voided' : ''); ?>">
                                    <?php if($tlLog->performer): ?>
                                        <div class="tl-action"><?php echo e($tlLog->performer->name); ?><?php if($isVoided): ?> <span class="tl-void-badge">VOIDED</span><?php endif; ?></div>
                                    <?php elseif($isVoided): ?>
                ...
                <div class="card-body">
                    <?php if(!$canAct): ?>
                        <div class="alert-info">
                            ...
                            This document is currently at <strong><?php echo e($document->currentOffice?->name ?? 'another office'); ?></strong>.
                            You can only act on documents at your office.
                        </div>
                    <?php elseif($canAct && !$isHandler): ?>
                        <div class="alert-info">
                            <i class="fas fa-tag" style="margin-right:5px"></i>
                            This document is currently tagged to <strong><?php echo e($document->currentHandler->name); ?></strong>.
                    ...
                    <?php else: ?>
                        ...
                        <?php if(($user->isRecords() || $user->isSuperAdmin()) && in_array($document->status, ['in_review','for_pickup'])): ?>
                            ...
                            <?php if($document->status === 'for_pickup'): ?>
                                <hr class="divider">
                                <div class="action-section">
                        ...
                        <?php if(!$canAccept && !(($user->isRecords() || $user->isSuperAdmin()) && in_array($document->status, ['in_review','for_pickup']))): ?>
...
var docId = <?php echo e($document->id); ?>;
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\office\document.blade.php ENDPATH**/ ?>