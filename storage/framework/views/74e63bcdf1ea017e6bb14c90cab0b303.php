    ...
    <div class="receive-container">
        ...
        <div class="card-body">
            ...
            <div class="doc-info" id="docInfo">
                ...
                <div class="btn-row">
                    <a href="<?php echo e($backUrl ?? '/office/dashboard'); ?>" class="btn"><i class="fas fa-times"></i> Cancel</a>
            ...
            <div class="success-state" id="successState">
                ...
                <a href="<?php echo e($backUrl ?? '/office/dashboard'); ?>" class="btn confirm">Go to Dashboard</a>
            </div>
        </div>
    </div>
</div>
...
(function(){
    ...
    var tracking = <?php echo json_encode($tracking, 15, 512) ?>;
    var receiveEndpoint = <?php echo json_encode($receiveEndpoint ?? '/api/office/documents/receive-by-reference', 15, 512) ?>;
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\office\receive.blade.php ENDPATH**/ ?>