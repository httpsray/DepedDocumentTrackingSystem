    ...
    <div class="dash-wrapper">
        ...
        <div class="stats-row anim">
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e($stats['total']); ?></div>
            ...
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e($stats['received']); ?></div>
            ...
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e($stats['forwarded']); ?></div>
            ...
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e($stats['completed']); ?></div>
        ...
        <form class="filters anim" method="GET" action="/admin/documents">
            <input type="text" name="search" class="filter-input" placeholder="Search tracking no., subject, or sender..." value="<?php echo e($filters['search']); ?>">
            <select name="status" class="filter-select">
                <option value="">All Status</option>
                <option value="received" <?php echo e($filters['status'] === 'received' ? 'selected' : ''); ?>>Received</option>
                <option value="forwarded" <?php echo e($filters['status'] === 'forwarded' ? 'selected' : ''); ?>>Forwarded</option>
        ...
        <div class="panel anim">
            <div class="panel-head">
                ...
                <span class="panel-badge"><?php echo e($documents->total()); ?> total</span>
            </div>
            ...
            <table class="dtable">
                ...
                <tbody>
                    ...
                    <tr id="doc-row-<?php echo e($doc->id); ?>">
                        ...
                        <td>
                            ...
                            ?>
                            <span class="pill <?php echo e($sc); ?>" id="doc-status-<?php echo e($doc->id); ?>"><?php echo e(ucfirst($doc->status)); ?></span>
                        </td>
                        <td class="t-date"><?php echo e($doc->created_at->format('M d, Y')); ?></td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-sm" onclick="viewDoc(<?php echo e($doc->id); ?>)" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <div class="status-dropdown">
                                    <button class="btn-sm status-btn" onclick="toggleStatusMenu(<?php echo e($doc->id); ?>)" title="Update Status">
                                        <i class="fas fa-exchange-alt"></i>
                                    </button>
                                    <div class="status-menu" id="status-menu-<?php echo e($doc->id); ?>">
                                        <button class="status-opt" onclick="updateDocStatus(<?php echo e($doc->id); ?>, 'received')">
                                            <i class="fas fa-inbox" style="color:#9a3412;"></i> Received
                                        </button>
                                        <button class="status-opt" onclick="updateDocStatus(<?php echo e($doc->id); ?>, 'forwarded')">
                                            <i class="fas fa-share" style="color:#1e40af;"></i> Forwarded
                                        </button>
                                        <button class="status-opt" onclick="updateDocStatus(<?php echo e($doc->id); ?>, 'completed')">
                                            <i class="fas fa-check-circle" style="color:#166534;"></i> Completed
                                        </button>
                                    </div>
                                </div>
                                <button class="btn-sm delete" onclick="confirmDelete(<?php echo e($doc->id); ?>, '<?php echo e($doc->tracking_number); ?>')" title="Delete">
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views/admin/documents.blade.php ENDPATH**/ ?>