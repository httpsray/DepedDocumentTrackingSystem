...
<div class="main">
    ...
    <div class="search-bar-card">
        <form method="GET" action="/representative/search" class="search-form" data-live-search>
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" data-clearable data-no-capitalize
                   placeholder="Tracking number, subject, sender name...">
            <select name="status">
                <option value="">All Statuses</option>
                <?php $__currentLoopData = ['submitted','in_review','forwarded','completed','for_pickup','returned','cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="table-card list-table-card<?php echo e($documents->isNotEmpty() ? ' has-list' : ''); ?>">
            ...
            <h2>
                ...
                <?php if(request('search') || request('status')): ?>
                    <span style="font-size:12px;color:var(--text-muted);font-weight:400;margin-left:8px">
                        — <?php echo e(\App\Support\UiNumber::compact($documents->total())); ?> document(s) found
                    </span>
                <?php endif; ?>
            </h2>
        </div>
                ...
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="font-family:monospace;font-size:12px;font-weight:600;color:var(--primary)">
                            <?php echo e($doc->reference_number); ?>

                        </td>
                        <td style="max-width:180px">
                            <div class="cell-ellipsis" style="font-weight:600" title="<?php echo e($doc->subject); ?>"><?php echo e($doc->subject); ?></div>
                        </td>
                        <td style="font-size:12px"><div class="cell-ellipsis" style="max-width:150px" title="<?php echo e($doc->type); ?>"><?php echo e($doc->type); ?></div></td>
                        ...
                        <td style="font-size:12px"><?php echo e($doc->currentOffice?->name ?? 'No office assigned'); ?></td>
                        <td style="font-size:11px;color:var(--text-muted)">
                            <?php echo e($doc->last_action_at ? \Carbon\Carbon::parse($doc->last_action_at)->diffForHumans() : $doc->created_at->diffForHumans()); ?>

                        </td>
                        <td>
                            <a href="/representative/documents/<?php echo e($doc->id); ?>" class="btn-view">
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\representative\search.blade.php ENDPATH**/ ?>