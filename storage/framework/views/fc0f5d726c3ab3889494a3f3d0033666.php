    ...
    <div class="search-bar-card">
        <form method="GET" action="/representative/search" class="search-form" data-live-search>
            ...
            <select name="status">
                ...
                <?php $__currentLoopData = ['submitted','in_review','forwarded','completed','for_pickup','returned']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
