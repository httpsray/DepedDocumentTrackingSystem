...
<div class="dash-wrapper">
    ...
    <!-- Table Card -->
    <div class="table-card dashboard-table-card queue-panel<?php echo e($documents->count() ? ' has-list' : ''); ?>">
            ...
            <div class="filters">
                ...
                <div class="filter-row">
                    <select id="tblStatus" onchange="filterTable()">
                        ...
                        <?php $__currentLoopData = \App\Models\Document::FILTER_STATUSES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table id="docTable">
            ...
            <tbody>
                ...
                <tr class="doc-row" data-search="<?php echo e(strtolower(($doc->reference_number ?: $doc->tracking_number).' '.$doc->subject.' '.$sender.' '.($doc->type ?? ''))); ?>" data-status="<?php echo e($doc->status); ?>" onclick='openDocDetail("<?php echo e($doc->reference_number ?: $doc->tracking_number); ?>")'>
                    ...
                    <td class="t-subject" style="max-width:200px"><div class="cell-ellipsis" style="font-weight:600" title="<?php echo e($doc->subject); ?>"><?php echo e($doc->subject); ?></div></td>
                    <td class="t-submitted">
                        <div class="cell-ellipsis submission-person" title="<?php echo e($sender); ?>"><?php echo e($sender); ?></div>
        ...
        <div class="mob-cards">
            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $sender = $doc->user ? $doc->user->name : ($doc->sender_name ?? 'Guest'); ?>
            <div class="mob-card" data-search="<?php echo e(strtolower(($doc->reference_number ?: $doc->tracking_number).' '.$doc->subject.' '.$sender.' '.($doc->type ?? ''))); ?>" data-status="<?php echo e($doc->status); ?>" onclick='openDocDetail("<?php echo e($doc->reference_number ?: $doc->tracking_number); ?>")'>
                ...
                <div class="mob-card-row">
                    ...
                    <span class="cell-ellipsis" title="<?php echo e($sender); ?>"><?php echo e($sender); ?></span>
                </div>
                <?php if($doc->status === 'submitted'): ?>
                <div class="mob-card-actions">
                    <button class="btn-accept" onclick="event.stopPropagation(); quickAccept(<?php echo e($doc->id); ?>, this)"><i class="fas fa-check"></i> Accept</button>
                </div>
                <?php endif; ?>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
