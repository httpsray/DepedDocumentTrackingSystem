    ...
    <div class="dash-wrapper">
        ...
        <form class="filters anim" method="GET" action="/admin/users" id="searchForm" data-live-search>
            <div class="filter-search-wrap">
                ...
                <input type="text" id="usersSearch" name="search" class="filter-input" placeholder="Search name, email, or mobile..." value="<?php echo e($filters['search']); ?>" data-clearable data-no-capitalize>
            </div>
            <div class="filter-select-wrap">
                <span class="filter-select-icon" aria-hidden="true"><?php echo $__env->make('partials.filter-icon', ['size' => 14], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></span>
        ...
        <!-- Users Table -->
        <div class="panel list-panel<?php echo e($users->count() ? ' has-list' : ''); ?> anim">
            <div class="panel-head">
                <div class="panel-title">Registered Users</div>
                <span class="panel-badge"><?php echo e(\App\Support\UiNumber::compact($users->total())); ?> total</span>
            </div>
            ...
            <table class="dtable">
                ...
                <tbody>
                    ...
                    <tr id="user-row-<?php echo e($u->id); ?>">
                        ...
                        <td><!--email_off--><?php echo e($u->email); ?><!--/email_off--></td>
            ...
            <div class="mob-cards">
                ...
                <div class="mob-card" id="mob-user-row-<?php echo e($u->id); ?>">
                    ...
                    <div class="mob-card-row">
                        ...
                        <span class="value"><!--email_off--><?php echo e($u->email); ?><!--/email_off--></span>
                    </div>
                    <div class="mob-card-row">
