    ...
    <div class="dash-wrapper">
        ...
        <div class="stats-row anim">
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e(\App\Support\UiNumber::compact($stats['total'])); ?></div>
            ...
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e(\App\Support\UiNumber::compact($stats['processing'])); ?></div>
            ...
            <div class="mini-stat">
                ...
                <div>
                    <div class="mini-stat-num"><?php echo e(\App\Support\UiNumber::compact($stats['completed'])); ?></div>
        ...
        <form class="filters anim" method="GET" action="/admin/documents" id="searchForm" data-live-search>
            <input type="text" name="search" class="filter-input" placeholder="Search tracking/reference no., subject, or sender..." value="<?php echo e($filters['search']); ?>" data-clearable data-no-capitalize>
            <select name="status" class="filter-select">
                <option value="">All Status</option>
                <?php $__currentLoopData = \App\Models\Document::FILTER_STATUSES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e($filters['status'] === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <button type="submit" class="filter-btn" id="searchBtn" data-no-auto-loading><?php echo $__env->make('partials.filter-icon', ['size' => 16], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> Search</button>
        ...
        <!-- Documents Table -->
        <div class="panel list-panel<?php echo e($documents->count() > 0 ? ' has-list' : ''); ?> anim">
            <div class="panel-head">
                <div class="panel-title">Documents</div>
                <span class="panel-badge"><?php echo e(\App\Support\UiNumber::compact($documents->total())); ?> total</span>
            </div>
            ...
            <table class="dtable">
                ...
                <tbody>
                    ...
                    <tr class="doc-row" id="doc-row-<?php echo e($doc->id); ?>" onclick='viewDoc(<?php echo json_encode($doc->tracking_number, 15, 512) ?>)'>
                        ...
                        <td>
                            ...
                            ?>
                            <span class="pill <?php echo e($sc); ?>" id="doc-status-<?php echo e($doc->id); ?>"><?php echo e($statusLabel); ?></span>
                        </td>
            ...
            <div class="mob-cards">
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mob-card" onclick='viewDoc(<?php echo json_encode($doc->tracking_number, 15, 512) ?>)'>
