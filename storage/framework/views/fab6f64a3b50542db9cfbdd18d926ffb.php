...
<head>
    ...
    <title>Reset Your Password — DocTrax</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 36px 36px 24px;">
                            ...
                            <p style="margin: 0 0 24px; color: #334155; font-size: 14px; line-height: 1.7;">
                                We received a request to reset your DepEd DOCTRAX password. Click the button below to set a new password. This link will expire in <strong>60 minutes</strong>.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="padding: 8px 0 28px;">
                                        <a href="<?php echo e($resetUrl); ?>" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #0056b3 0%, #004494 100%); color: #ffffff; text-decoration: none; padding: 14px 40px; border-radius: 8px; font-size: 14px; font-weight: 600; letter-spacing: 0.3px;">
                                            Reset My Password
                                        </a>
                                    </td>
                                </tr>
