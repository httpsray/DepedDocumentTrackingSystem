...
<div class="sidebar" id="mainSidebar">
    ...
    <nav class="sb-nav">
        <?php if($user->isRepresentative() && $user->office_id && !$user->isAdmin()): ?>
...
<div class="main">
    ...
    <?php if($document->status === 'archived'): ?>
        <div class="archive-badge">
            ...
            This document was auto-archived on <?php echo e($document->archived_at ? $document->archived_at->format('M d, Y h:i A') : 'N/A'); ?> — it was not received within 7 days of submission.
        </div>
    <?php endif; ?>
    ...
    <div class="two-col">
        ...
        <div>
            <div class="card" style="margin-bottom:18px">
                <div class="card-head">
                    <div>
                        <h2 style="word-wrap:break-word;overflow-wrap:break-word"><?php echo e($document->subject); ?></h2>
                        <p style="font-family:monospace;letter-spacing:.5px"><?php echo e($document->tracking_number); ?></p>
                    </div>
                    <span class="status-badge" style="
                        background:<?php echo e($document->statusColor()); ?>1a;
                        color:<?php echo e($document->statusColor()); ?>;
                        border:1.5px solid <?php echo e($document->statusColor()); ?>55">
                        <?php echo e($document->statusLabel()); ?>
                ...
                <div class="card-body">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="value" style="font-family:monospace"><?php echo e($document->reference_number ?: 'N/A'); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="label">Internal Reference</div>
                            <div class="value" style="font-family:monospace"><?php echo e($document->tracking_number); ?></div>
                        </div>

                        <div class="info-item">
                            <div class="label">Sender Contact</div>
                            <div class="value"><?php echo e($document->sender_contact ?? 'No contact provided'); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="label">Date Submitted</div>
                            <div class="value"><?php echo e($document->created_at->format('M d, Y h:i A')); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="label">Last Action</div>
                            <div class="value"><?php echo e($document->last_action_at ? $document->last_action_at->format('M d, Y h:i A') : 'No activity yet'); ?></div>
                        </div>
                        <?php if($document->description): ?>
                        <div class="info-item full">
                            <div class="label">Description</div>
                            <div class="value"><?php echo e($document->description); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($document->routingLogs->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        ...
                        ?>
                        <div class="timeline">
                            <?php $__currentLoopData = $tlGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tlGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <div class="tl-office-hdr"><div class="tl-dot <?php echo e($hdrDc); ?>" style="margin-right:5px"><i class="fas <?php echo e($hdrIcon); ?>" style="font-size:5px"></i></div><span><?php echo e($tlGroup['label']); ?></span></div>
                                <?php $__currentLoopData = array_reverse($tlGroup['logs']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tlLog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                    <div class="tl-item">
                                        <?php if($tlLog->performer): ?>
                                            <div class="tl-action"><?php echo e($tlLog->performer->name); ?></div>
                                        <?php endif; ?>
                                        <div class="tl-meta"><i class="fas fa-clock" style="margin-right:3px;font-size:10px"></i><?php echo e($tlLog->created_at->setTimezone('Asia/Manila')->format('M d, Y h:i A')); ?></div>
                                        <div class="tl-meta"><i class="fas fa-tasks" style="margin-right:3px;font-size:10px"></i><?php echo e($tlLog->actionLabel()); ?></div>
                                        <?php if($tlLog->remarks): ?><div class="tl-remarks"><?php echo e($tlLog->remarks); ?></div><?php endif; ?>
                                    </div>
                ...
                <div class="card-body">
                    <div style="font-size:13px;color:var(--text-muted);line-height:1.8">
                        <div style="margin-bottom:12px">
                            <strong style="color:var(--text-dark)">Submitted by:</strong> <?php echo e($document->sender_name); ?>

                        </div>
                        <div style="margin-bottom:12px">
                            <strong style="color:var(--text-dark)">Status:</strong>
                            <span style="color:<?php echo e($document->statusColor()); ?>;font-weight:600"><?php echo e($document->statusLabel()); ?></span>
                        </div>
                        <div style="margin-bottom:12px">
                        ...
                        <div style="margin-bottom:12px">
                            <strong style="color:var(--text-dark)">Registered User:</strong> <?php echo e($document->user->name); ?>

                            <div style="font-size:11px;color:#94a3b8"><!--email_off--><?php echo e($document->user->email); ?><!--/email_off--></div>
                        </div>
                        <?php endif; ?>
                        <div style="margin-bottom:12px">
                            <strong style="color:var(--text-dark)">Routing Steps:</strong> <?php echo e($document->routingLogs->count()); ?>
                    ...
                    <?php if($document->status === 'submitted'): ?>
                        <div style="margin-top:16px;padding:12px 14px;background:#fffbeb;border:1px solid #fde68a;border-radius:8px;font-size:12px;color:#92400e">
                            ...
                            <?php if($document->created_at->diffInDays(now()) >= 5): ?>
                                <strong>It will be auto-archived in <?php echo e(max(0, 7 - $document->created_at->diffInDays(now()))); ?> day(s) if not received.</strong>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\records\document.blade.php ENDPATH**/ ?>