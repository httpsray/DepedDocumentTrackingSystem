...
<head>
    <meta charset="UTF-8">
    <link rel="icon" href="images/DOCTRAXLOGO.svg">
...
<div class="sidebar" id="mainSidebar">
    ...
    <div class="sb-footer">
        <div class="sb-user">
            <div class="sb-avatar" id="navAvatar"><?php echo e($initials); ?></div>
            <div class="sb-user-info">
                <small><?php echo e($navRole); ?></small>
                <span id="navName"><?php echo e($displayFirst); ?></span>
            </div>
        </div>
    ...
    <div class="profile-card anim">
        ...
        <div class="profile-info-grid">
            ...
            <div class="info-item">
                ...
                <div class="info-value" id="infoEmail"><?php echo e($user->email); ?></div>
            </div>
            <div class="info-item">
                ...
                <div class="form-row full">
                    <div class="form-group">
                        <label for="middleName">
                            Middle Name
                            <span style="color:#dc2626" id="midAsterisk"><?php echo e($hasMiddle ? '*' : ''); ?></span>
                        </label>
                        <input type="text" id="middleName"
                               value="<?php echo e($middleName); ?>"
                               maxlength="100" autocomplete="off"
                               oninput="this.value=this.value.replace(/[^a-zA-Z\u00C0-\u024F\s\-\.\x27]/g,'')"
                               <?php echo e(!$hasMiddle ? 'disabled style="opacity:.5"' : ''); ?>>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views/dashboard/profile.blade.php ENDPATH**/ ?>