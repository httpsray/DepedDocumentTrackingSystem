...
<body>
    <div class="report-shell">
            ...
            <table class="head-table">
                <tr>
                    <td>
                        ...
                        <div class="subtitle"><?php echo e($displayName); ?> | <?php echo e($officeName); ?></div>
                    </td>
                    <td class="head-right">
        ...
        <div class="meta-line">
            <strong><?php echo e($docs->count()); ?></strong> record(s)
            <?php if($statusLabel !== 'All'): ?>
                <span class="meta-sep">|</span>
                Status: <strong><?php echo e($statusLabel); ?></strong>
            <?php endif; ?>
            <?php if($dateFromLabel !== 'N/A' || $dateToLabel !== 'N/A'): ?>
                <span class="meta-sep">|</span>
                Date Range: <strong><?php echo e($dateFromLabel); ?> to <?php echo e($dateToLabel); ?></strong>
            <?php endif; ?>
        </div>
        ...
        <?php else: ?>
            <table class="data-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="muted"><?php echo e($doc->sender_name ?: 'Guest'); ?></div>
                            </td>
                            <td><span class="badge"><?php echo e($doc->statusLabel()); ?></span></td>
                            <td>
                                <div><?php echo e($currentOffice); ?></div>
                                <div class="muted"><?php echo e($doc->currentHandler?->name ?? 'Unassigned'); ?></div>
                            </td>
                            <td>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\pdf\user-report.blade.php ENDPATH**/ ?>