...
<div class="main">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e(\App\Support\UiNumber::compact($stats['incoming'])); ?></h3>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e(\App\Support\UiNumber::compact($stats['in_review'])); ?></h3>
                <p>Processing</p>
            </div>
        </div>
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e(\App\Support\UiNumber::compact($stats['completed'])); ?></h3>
                <p>Completed</p>
            </div>
        </div>
    </div>
        ...
        <?php else: ?>
            ...
            <table id="docsTable">
                ...
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-status="<?php echo e($doc->status); ?>" data-search="<?php echo e(strtolower($doc->subject . ' ' . $doc->sender_name)); ?>">
                        ...
                        <td>
                            <div style="display:flex;gap:6px;align-items:center">
                                <?php if(in_array($doc->status, ['submitted', 'forwarded'])): ?>
                                    <button class="btn-accept" onclick="quickAccept(<?php echo e($doc->id); ?>, this)">
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\representative\dashboard.blade.php ENDPATH**/ ?>