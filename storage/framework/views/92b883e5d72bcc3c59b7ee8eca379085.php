...
<div class="main">
    ...
    <!-- Documents Table -->
    <div class="table-card list-table-card my-docs-panel<?php echo e($documents->count() ? ' has-list' : ''); ?>">
        <div class="table-head">
            <div class="table-head-left">
                <span class="table-title">Results</span>
                <span class="table-doc-count" id="totalCount"><?php echo e(\App\Support\UiNumber::compact($documents->total())); ?> total</span>
            </div>
        </div>
        ...
        <?php else: ?>
            ...
            <table id="docsTable">
                ...
                <tbody>
                    ...
                    ?>
                    <tr class="doc-row"
                        data-search="<?php echo e(strtolower($docRef . ' ' . $docTracking . ' ' . $doc->subject . ' ' . $doc->type)); ?>"
                        data-status="<?php echo e($doc->status); ?>"
                        data-ref="<?php echo e($docRef); ?>"
                        data-tracking="<?php echo e($docTracking); ?>">
                        <td class="t-ref">
                            <div class="cell-ellipsis" title="<?php echo e($docRef); ?>"><?php echo e($docRef); ?></div>
                        </td>
                        <td class="t-track">
                            <div class="cell-ellipsis" title="<?php echo e($docTracking); ?>"><?php echo e($docTracking); ?></div>
                        </td>
                        <td class="t-subject">
                            <span class="t-subject-main" title="<?php echo e($doc->subject); ?>"><?php echo e($doc->subject); ?></span>
                            <span class="t-subject-sub" title="<?php echo e($doc->type); ?>"><?php echo e($doc->type); ?></span>
                        </td>
                        <td class="t-office">
                            <div class="cell-ellipsis" title="<?php echo e($docOffice); ?>"><?php echo e($docOffice); ?></div>
                        </td>
                    ...
                    >
                        <div class="mob-card-top">
                            <div class="mob-card-ids">
                                <div class="mob-card-ref"><?php echo e($docRef); ?></div>
                                <div class="mob-card-track">Tracking: <?php echo e($docTracking); ?></div>
                            </div>
                        ...
                        <div class="mob-card-row">
                            ...
                            <span class="cell-ellipsis" title="<?php echo e($docOffice); ?>"><?php echo e($docOffice); ?></span>
                        </div>
                        <div class="mob-card-row">
                            <i class="fas fa-tag"></i>
                            <span class="cell-ellipsis" title="<?php echo e($doc->type); ?>"><?php echo e($doc->type); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state">
