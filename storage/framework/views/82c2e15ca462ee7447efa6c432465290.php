...
<div class="main">
    <div class="dash-wrapper">
        ...
        <div class="panel list-panel<?php echo e($accounts->count() ? ' has-list' : ''); ?>">
            <div class="panel-head">
                <div class="panel-title">Office Accounts (<?php echo e($accounts->count()); ?>)</div>
            </div>
            ...
            <table class="dtable">
                ...
                <tbody>
                    ...
                    <tr id="acc-row-<?php echo e($acc->id); ?>">
                        <td>
                            <div class="name-cell">
                                <span class="name-main"><?php echo e($acc->name); ?></span>
                            </div>
                        </td>
                        <td>
                            <span style="font-size:13px;font-weight:600;color:var(--primary);" id="acc-office-<?php echo e($acc->id); ?>">
                                <?php echo e($acc->office->name ?? 'No office assigned'); ?>

                            </span>
                        </td>
                        <td><!--email_off--><?php echo e($acc->email); ?><!--/email_off--></td>
                        <td><?php echo e($acc->mobile ?? 'No number provided'); ?></td>
                        <td>
                            <span class="badge-reports <?php echo e($acc->has_reports_access ? 'on' : 'off'); ?>" id="acc-reports-badge-<?php echo e($acc->id); ?>">
                                <?php if($acc->has_reports_access): ?><i class="fas fa-chart-line"></i><?php endif; ?>
                                <?php echo e($acc->has_reports_access ? 'Enabled' : 'Disabled'); ?>

                            </span>
                        </td>
                        <td>
                            <span class="pill <?php echo e($acc->status); ?>"><?php echo e(ucfirst($acc->status)); ?></span>
                        </td>
                        <td>
                            <div class="action-btns">
                                <button class="btn-sm <?php echo e($acc->has_reports_access ? 'reports-on' : 'reports-off'); ?>" id="acc-reports-btn-<?php echo e($acc->id); ?>" onclick="toggleReports(<?php echo e($acc->id); ?>, '<?php echo e(addslashes($acc->name)); ?>')" title="<?php echo e($acc->has_reports_access ? 'Revoke reports access' : 'Grant reports access'); ?>">
                                    <i class="fas fa-chart-line"></i>
                                </button>
                                <button class="btn-sm transfer" onclick="openTransferModal(<?php echo e($acc->id); ?>, '<?php echo e(addslashes($acc->name)); ?>', <?php echo e($acc->office_id); ?>)" title="Transfer to another office">
                                    <i class="fas fa-exchange-alt"></i>
                                </button>
                                <?php if($acc->status !== 'suspended'): ?>
                                <button class="btn-sm suspend" onclick="confirmStatus(<?php echo e($acc->id); ?>, 'suspended', '<?php echo e(addslashes($acc->name)); ?>')" title="Deactivate">
                                    <i class="fas fa-ban"></i>
                                </button>
                                <?php else: ?>
                                <button class="btn-sm activate" onclick="confirmStatus(<?php echo e($acc->id); ?>, 'active', '<?php echo e(addslashes($acc->name)); ?>')" title="Activate">
            ...
            <div class="mob-cards">
                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mob-card" id="mob-acc-<?php echo e($acc->id); ?>">
                    <div class="mob-card-head">
                        <div>
                            <div class="mob-card-name"><?php echo e($acc->name); ?></div>
                            <div class="mob-card-office" id="mob-acc-office-<?php echo e($acc->id); ?>">
                    ...
                    <div class="mob-card-row">
                        ...
                        <span class="value"><!--email_off--><?php echo e($acc->email); ?><!--/email_off--></span>
                    </div>
                    <div class="mob-card-row">
                        <span class="label">Mobile</span>
                        <span class="value"><?php echo e($acc->mobile ?? 'No number provided'); ?></span>
                    </div>
                    <div class="mob-card-row">
                        <span class="label">Reports</span>
                        <span class="value">
                            <span class="badge-reports <?php echo e($acc->has_reports_access ? 'on' : 'off'); ?>" id="mob-acc-reports-badge-<?php echo e($acc->id); ?>">
                                <?php if($acc->has_reports_access): ?><i class="fas fa-chart-line"></i><?php endif; ?>
                                <?php echo e($acc->has_reports_access ? 'Enabled' : 'Disabled'); ?>
                    ...
                    <div class="mob-card-actions">
                        <button class="btn-sm <?php echo e($acc->has_reports_access ? 'reports-on' : 'reports-off'); ?>" id="mob-acc-reports-btn-<?php echo e($acc->id); ?>" onclick="toggleReports(<?php echo e($acc->id); ?>, '<?php echo e(addslashes($acc->name)); ?>')" title="<?php echo e($acc->has_reports_access ? 'Revoke reports access' : 'Grant reports access'); ?>">
                            <i class="fas fa-chart-line"></i> Reports
                        </button>
                        <button class="btn-sm transfer" onclick="openTransferModal(<?php echo e($acc->id); ?>, '<?php echo e(addslashes($acc->name)); ?>', <?php echo e($acc->office_id); ?>)" title="Transfer">
                ...
                <div class="modal-field">
                    ...
                    <div class="modal-select-wrap"><select class="modal-input" id="createOfficeId" style="box-sizing:border-box" onchange="toggleCustomOffice()">
                        ...
                        <?php $__currentLoopData = $offices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($office->id); ?>" data-name="<?php echo e($office->name); ?>"><?php echo e($office->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\admin\offices.blade.php ENDPATH**/ ?>