...
<div class="dash-wrapper">
    ...
    <a href="<?php echo e($backUrl); ?>" class="back-link"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
    ...
    <div class="table-card">
        <div class="table-head">
            <span class="table-title">Results <span id="totalCount" style="font-weight:400;color:var(--text-muted)">(<?php echo e($documents->total()); ?>)</span></span>
        </div>
