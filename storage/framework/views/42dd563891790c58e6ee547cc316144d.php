    ...
    <div class="dash-wrapper">
        ...
        <div class="top-bar anim">
            <div class="greeting-section">
                <h1>Welcome back, <?php echo e($dashboardWelcomeName); ?>!</h1>
                <p><?php echo e($dashboardContextLabel); ?> &mdash; here's your document overview.</p>
            </div>
        ...
        <div class="stats">
            <div class="stat-card blue anim">
                ...
                <div class="s-data">
                    <div class="s-num" id="stat-total"><?php echo e(\App\Support\UiNumber::compact($stats['total'])); ?></div>
            ...
            <div class="stat-card orange anim">
                ...
                <div class="s-data">
                    <div class="s-num" id="stat-pending"><?php echo e(\App\Support\UiNumber::compact($stats['pending'])); ?></div>
            ...
            <div class="stat-card green anim">
                ...
                <div class="s-data">
                    <div class="s-num" id="stat-completed"><?php echo e(\App\Support\UiNumber::compact($stats['completed'])); ?></div>
        ...
        <div class="pickup-banner anim">
            <div class="pickup-banner-title">
                Ready for Pickup <span class="pickup-count"><?php echo e(\App\Support\UiNumber::compact($pickupDocs->count())); ?></span>
            </div>
            ...
            <div class="panel panel-fixed recent-docs-panel anim" id="recentDocumentsPanel">
                ...
                <table class="dtable">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr onclick='window.location.href=<?php echo json_encode($recentDocUrl, 15, 512) ?>'>
                            <td class="t-ref"><div class="cell-ellipsis" title="<?php echo e($recentLookup); ?>"><?php echo e($recentLookup); ?></div></td>
                ...
                <div class="mob-cards">
                    ...
                    <?php
                        ...
                        $recentDocUrl = '/my-documents?search=' . urlencode($recentLookup);
                    ?>
                    <div class="mob-card" onclick='window.location.href=<?php echo json_encode($recentDocUrl, 15, 512) ?>'>
                        <div class="mob-card-top">
                            <div class="mob-card-ref"><?php echo e($recentLookup); ?></div>
                        ...
                        <div class="mob-card-row">
                            ...
                            <span class="cell-ellipsis" title="<?php echo e($doc->currentOffice?->name ?? 'Awaiting routing'); ?>"><?php echo e($doc->currentOffice?->name ?? 'Awaiting routing'); ?></span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\dashboard\index.blade.php ENDPATH**/ ?>