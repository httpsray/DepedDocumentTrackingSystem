...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        body { background:var(--bg); font-family:'Poppins',sans-serif; color:var(--text-dark); min-height:100vh; }
        ...
        @media(max-width:480px){
            .dash-wrapper{padding:20px 14px 40px}
...
<div class="dash-wrapper">
    ...
    <div class="search-card">
        <h2><i class="fas fa-search" style="color:var(--primary)"></i> Track Document</h2>
        <p>Enter the 8-character Tracking Number to view the current status and full routing history.</p>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\admin\track.blade.php ENDPATH**/ ?>