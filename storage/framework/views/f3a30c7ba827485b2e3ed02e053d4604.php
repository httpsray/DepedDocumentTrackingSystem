...
<div class="main">
    <div class="dash-wrapper">
        ...
        <form class="filters anim" method="GET" action="/my-documents" id="searchForm" data-live-search>
            <input type="text" name="search" class="filter-input" placeholder="Search tracking/reference no. or subject..." value="<?php echo e($search); ?>" data-clearable data-no-capitalize>
        ...
        <div class="panel list-panel<?php echo e($documents->count() > 0 ? ' has-list' : ''); ?> anim">
            ...
            <table class="dtable">
                ...
                <tbody>
                    ...
                    <tr class="doc-row" onclick='viewDoc(<?php echo json_encode($doc->tracking_number, 15, 512) ?>)'>
                        <td>
                        ...
                        <td class="t-type"><div class="cell-ellipsis" style="max-width:160px" title="<?php echo e($doc->type ?? 'No type specified'); ?>"><?php echo e($doc->type ?? 'No type specified'); ?></div></td>
                        <td>
                            <?php
                                $sc = match($doc->status) {
                            ...
                            ?>
                            <span class="pill <?php echo e($sc); ?>"><?php echo e($statusLabel); ?></span>
                        </td>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\admin\my-documents.blade.php ENDPATH**/ ?>