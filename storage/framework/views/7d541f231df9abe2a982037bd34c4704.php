...
<div class="main">
    ...
    <div class="filters-card">
        <form method="GET" action="<?php echo e(route('office.search')); ?>" id="reportForm">
    ...
    <div class="table-card">
        <div class="table-head">
            <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
                ...
                <span class="table-doc-count"><?php echo e($documents->total()); ?> row(s)</span>
            </div>
        ...
        <?php else: ?>
            ...
            <table>
                ...
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="doc-row" data-ref="<?php echo e($doc->tracking_number); ?>" data-tracking="<?php echo e($doc->tracking_number); ?>">
                        <td><div class="mono"><?php echo e($doc->tracking_number); ?></div></td>
                        <td><div class="mono"><?php echo e($doc->reference_number ?: 'N/A'); ?></div></td>
                        ...
                        <td><?php echo e($doc->sender_name); ?></td>
                        ...
                        <td>
                            <a href="/office/documents/<?php echo e($doc->id); ?>?from=reports" class="btn-manage" onclick="event.stopPropagation()"><i class="fas fa-sliders-h"></i> Manage</a>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            ...
            <div class="mob-doc-cards">
                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mob-doc-card" onclick="openDocDetail('<?php echo e($doc->tracking_number); ?>')">
                        <div class="mob-doc-ref"><?php echo e($doc->tracking_number); ?></div>
                        <div style="font-size:11px;color:var(--text-muted);font-family:monospace;margin-top:2px">Ref: <?php echo e($doc->reference_number ?: 'N/A'); ?></div>
                        ...
                        <div class="mob-doc-row">
                            ...
                            <a href="/office/documents/<?php echo e($doc->id); ?>?from=reports" class="btn-manage" onclick="event.stopPropagation()" style="font-size:11px;padding:5px 10px"><i class="fas fa-sliders-h"></i> Manage</a>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="user-card">
                    ...
                    <div class="u-stats-row">
                        <div class="u-stat">
                            <div class="u-stat-num" style="color:#0891b2"><?php echo e(number_format($u->handled_received_count)); ?></div>
                            <div class="u-stat-lbl">Processing</div>
                        </div>
                        <div class="u-stat">
                            <div class="u-stat-num" style="color:#f59e0b"><?php echo e(number_format($u->handled_pending_count)); ?></div>
                            <div class="u-stat-lbl">Pending</div>
                        </div>
                        <div class="u-stat">
                            <div class="u-stat-num" style="color:#16a34a"><?php echo e(number_format($u->handled_processed_count)); ?></div>
