        ...
        <div class="status-card">
            ...
            <?php if($status === 'already_active'): ?>
                <div class="status-body">
                    ...
                    <div class="info-box"><?php echo e($message); ?></div>
            ...
            <?php elseif($status === 'invalid'): ?>
                <div class="status-body">
                    ...
                    <div class="warning-box"><?php echo e($message); ?></div>
        ...
        async function resendActivation() {
            ...
            try {
                const response = await fetch('/api/resend-activation', {
                    ...
                    body: JSON.stringify({ email: "<?php echo e($email ?? ''); ?>" }),
                });
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views\auth\activation-status.blade.php ENDPATH**/ ?>