...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* ─── Content ─── */
        .about-wrapper { max-width:800px; width:100%; margin:0 auto; padding:28px 24px 48px; flex:1; }
        ...
        .about-card { background:#fff; border-radius:16px; box-shadow:0 4px 24px rgba(0,0,0,.06); padding:28px 32px; margin-bottom:24px; border:1px solid #e2e8f0; }
        .about-card h3 { font-size:16px; font-weight:700; color:var(--text-dark); margin-bottom:12px; display:flex; align-items:center; gap:10px; }
        .about-card h3 i { color:var(--primary); font-size:18px; }
        .about-card p, .about-card li { font-size:13.5px; color:#475569; line-height:1.75; }
        .about-card ul { list-style:none; padding:0; }
        .about-card ul li { padding:6px 0; display:flex; align-items:flex-start; gap:10px; }
        .about-card ul li i { color:var(--primary); margin-top:3px; flex-shrink:0; font-size:13px; }
        .about-grid { display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:24px; }
        .stat-card { background:#fff; border-radius:14px; box-shadow:0 2px 12px rgba(0,0,0,.04); padding:22px; text-align:center; border:1px solid #e2e8f0; }
        .stat-card .stat-icon { width:48px; height:48px; border-radius:12px; display:inline-flex; align-items:center; justify-content:center; font-size:20px; margin-bottom:10px; }
        .stat-card h4 { font-size:14px; font-weight:700; color:var(--text-dark); margin-bottom:4px; }
...
<div class="about-wrapper">
    ...
    <div class="about-hero">
        <img src="<?php echo e(asset('images/DOCTRAXLOGO.svg')); ?>" alt="DOCTRAX Logo">
        <h2>About DOCTRAX</h2>
        <p>DOCTRAX is the Document Tracking System built for the Schools Division of City of San Jose del Monte. It replaces manual logbooks and follow-ups with a single online platform where every document is tracked from submission to completion.</p>
    </div>

    <div class="about-card">
        <h3><i class="fas fa-bullseye"></i> What is DOCTRAX?</h3>
        <p>DOCTRAX lets anyone — walk-in clients, school personnel, or office staff — submit documents online and track them using a unique 8-character tracking number. Every action taken on a document is logged with a timestamp, the office involved, and the person responsible, creating a complete and transparent audit trail.</p>
    </div>

    <div class="about-card">
        <h3><i class="fas fa-clipboard-list"></i> How It Works</h3>
        <ul>
            <li><i class="fas fa-1" style="width:16px;text-align:center"></i> <div><strong>Submit</strong> — Fill out the online form and choose the destination office. You'll receive a tracking number instantly.</div></li>
            <li><i class="fas fa-2" style="width:16px;text-align:center"></i> <div><strong>Track</strong> — Enter your tracking number anytime to see exactly where your document is and what actions have been taken.</div></li>
            <li><i class="fas fa-3" style="width:16px;text-align:center"></i> <div><strong>Receive & Route</strong> — Office representatives accept incoming documents, process them, and forward them to the next office when needed.</div></li>
            <li><i class="fas fa-4" style="width:16px;text-align:center"></i> <div><strong>Complete</strong> — Once processing is done, the document is marked for pickup. The submitter confirms receipt to close the loop.</div></li>
        </ul>
    </div>

    <div class="about-grid">
        <div class="stat-card">
            <div class="stat-icon" style="background:rgba(0,86,179,.1);color:var(--primary)"><i class="fas fa-fingerprint"></i></div>
            <h4>Unique Tracking Numbers</h4>
            <p>Every document gets an 8-character code for quick and easy lookup — no account required.</p>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background:rgba(34,197,94,.1);color:#16a34a"><i class="fas fa-route"></i></div>
            <h4>Full Routing History</h4>
            <p>See the complete trail of every office, action, and timestamp from start to finish.</p>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background:rgba(249,115,22,.1);color:#ea580c"><i class="fas fa-hand-holding"></i></div>
            <h4>Pickup Confirmation</h4>
            <p>When your document is ready, confirm that you've received it to officially close the transaction.</p>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background:rgba(124,58,237,.1);color:#7c3aed"><i class="fas fa-mobile-alt"></i></div>
            <h4>Works on Any Device</h4>
            <p>Fully responsive — submit and track documents from your phone, tablet, or computer.</p>
        </div>
    </div>

    <div class="about-card">
        <h3><i class="fas fa-users"></i> Who Uses DOCTRAX?</h3>
        <ul>
            <li><i class="fas fa-user"></i> <div><strong>Walk-in Clients & School Personnel</strong> — Submit documents online and track their status using a tracking number.</div></li>
            <li><i class="fas fa-building"></i> <div><strong>Office Representatives</strong> — Accept, review, forward, and manage documents within their assigned office.</div></li>
            <li><i class="fas fa-user-shield"></i> <div><strong>Administrators</strong> — Manage user accounts, offices, and oversee the entire document workflow.</div></li>
        </ul>
    </div>
...
<?php /**PATH C:\Users\iamra\Desktop\DepedDocumentTrackingSystem\resources\views/dashboard/about.blade.php ENDPATH**/ ?>